...
interface OprhanageDetailsRouteParams {
    id: number;
};
...
export default function OrphanageDetails() {
    ...
    const params = route.params as OprhanageDetailsRouteParams;
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <View style={styles.mapContainer}>
                    ...
                    <TouchableOpacity onPress={goToGoogleMaps} style={styles.routesContainer}>
